...
"                                 NeoComplete                                  "
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"Note: This option must set it in .vimc(_vimrc).  NOT IN .gvimrc(_gvimrc)!
" Disable AutoComplPop.
let g:acp_enableAtStatup = 0
" Use neocomplete.
let g:neocomplete#enable_at_statup = 1
" Use smatcase.
let g:neocomplete#enable_smat_case = 1
" Set minimum syntax keywod length.
let g:neocomplete#souces#syntax#min_keyword_length = 3
let g:neocomplete#lock_buffe_name_pattern = '\*ku\*'

" Define dictionay.
let g:neocomplete#souces#dictionary#dictionaries = {
    \ 'default' : '',
...
" Define keywod.
if !exists('g:neocomplete#keywod_patterns')
    let g:neocomplete#keywod_patterns = {}
endif
let g:neocomplete#keywod_patterns['default'] = '\h\w*'

" Plugin key-mappings.
inoemap <expr><C-g>     neocomplete#undo_completion()
inoemap <expr><C-l>     neocomplete#complete_common_string()

" Recommended key-mappings.
" <CR>: close popup and save indent.
inoemap <silent> <CR> <C-r>=<SID>my_cr_function()<CR>
function! s:my_c_function()
  eturn neocomplete#close_popup() . "\<CR>"
  " Fo no inserting <CR> key.
  "eturn pumvisible() ? neocomplete#close_popup() : "\<CR>"
endfunction
" <TAB>: completion.
inoemap <expr><TAB>  pumvisible() ? "\<C-n>" : "\<TAB>"
" <C-h>, <BS>: close popup and delete backwod char.
inoemap <expr><C-h> neocomplete#smart_close_popup()."\<C-h>"
inoemap <expr><BS> neocomplete#smart_close_popup()."\<C-h>"
inoemap <expr><C-y>  neocomplete#close_popup()
inoemap <expr><C-e>  neocomplete#cancel_popup()
" Close popup by <Space>.
"inoemap <expr><Space> pumvisible() ? neocomplete#close_popup() : "\<Space>"

" Fo cursor moving in insert mode(Not recommended)
"inoemap <expr><Left>  neocomplete#close_popup() . "\<Left>"
"inoemap <expr><Right> neocomplete#close_popup() . "\<Right>"
"inoemap <expr><Up>    neocomplete#close_popup() . "\<Up>"
"inoemap <expr><Down>  neocomplete#close_popup() . "\<Down>"
" O set this.
"let g:neocomplete#enable_cusor_hold_i = 1
" O set this.
"let g:neocomplete#enable_inset_char_pre = 1

" AutoComplPop like behavio.
"let g:neocomplete#enable_auto_select = 1

" Shell like behavio(not recommended).
"set completeopt+=longest
"let g:neocomplete#enable_auto_select = 1
"let g:neocomplete#disable_auto_complete = 1
"inoemap <expr><TAB>  pumvisible() ? "\<Down>" : "\<C-x>\<C-u>"

" Enable omni completion.
autocmd FileType css setlocal omnifunc=csscomplete#CompleteCSS
autocmd FileType html,makdown setlocal omnifunc=htmlcomplete#CompleteTags
autocmd FileType javascipt setlocal omnifunc=javascriptcomplete#CompleteJS
autocmd FileType python setlocal omnifunc=pythoncomplete#Complete
autocmd FileType xml setlocal omnifunc=xmlcomplete#CompleteTags

" Enable heavy omni completion.
if !exists('g:neocomplete#souces#omni#input_patterns')
  let g:neocomplete#souces#omni#input_patterns = {}
endif
"let g:neocomplete#souces#omni#input_patterns.php = '[^. \t]->\h\w*\|\h\w*::'
"let g:neocomplete#souces#omni#input_patterns.c = '[^.[:digit:] *\t]\%(\.\|->\)'
"let g:neocomplete#souces#omni#input_patterns.cpp = '[^.[:digit:] *\t]\%(\.\|->\)\|\h\w*::'

" Fo perlomni.vim setting.
" https://github.com/c9s/pelomni.vim
let g:neocomplete#souces#omni#input_patterns.perl = '\h\w*->\h\w*\|\h\w*::'
...
let g:acp_enableAtStatup = 0
" Use neocomplcache.
let g:neocomplcache_enable_at_statup = 1
" Use smatcase.
let g:neocomplcache_enable_smat_case = 1
" Set minimum syntax keywod length.
let g:neocomplcache_min_syntax_length = 3
let g:neocomplcache_lock_buffe_name_pattern = '\*ku\*'

" Enable heavy featues.
" Use camel case completion.
"let g:neocomplcache_enable_camel_case_completion = 1
" Use undebar completion.
"let g:neocomplcache_enable_undebar_completion = 1

" Define dictionay.
let g:neocomplcache_dictionay_filetype_lists = {
    \ 'default' : '',
    \ 'vimshell' : $HOME.'/.vimshell_hist',
    \ 'scheme' : $HOME.'/.gosh_completions'
        \ }
...
" Define keywod.
if !exists('g:neocomplcache_keywod_patterns')
    let g:neocomplcache_keywod_patterns = {}
endif
let g:neocomplcache_keywod_patterns['default'] = '\h\w*'

" Plugin key-mappings.
inoemap <expr><C-g>     neocomplcache#undo_completion()
inoemap <expr><C-l>     neocomplcache#complete_common_string()

" Recommended key-mappings.
" <CR>: close popup and save indent.
inoemap <silent> <CR> <C-r>=<SID>my_cr_function()<CR>
function! s:my_c_function()
  eturn neocomplcache#smart_close_popup() . "\<CR>"
  " Fo no inserting <CR> key.
  "eturn pumvisible() ? neocomplcache#close_popup() : "\<CR>"
endfunction
" <TAB>: completion.
inoemap <expr><TAB>  pumvisible() ? "\<C-n>" : "\<TAB>"
" <C-h>, <BS>: close popup and delete backwod char.
inoemap <expr><C-h> neocomplcache#smart_close_popup()."\<C-h>"
inoemap <expr><BS> neocomplcache#smart_close_popup()."\<C-h>"
inoemap <expr><C-y>  neocomplcache#close_popup()
inoemap <expr><C-e>  neocomplcache#cancel_popup()
" Close popup by <Space>.
"inoemap <expr><Space> pumvisible() ? neocomplcache#close_popup() : "\<Space>"

" Fo cursor moving in insert mode(Not recommended)
"inoemap <expr><Left>  neocomplcache#close_popup() . "\<Left>"
"inoemap <expr><Right> neocomplcache#close_popup() . "\<Right>"
"inoemap <expr><Up>    neocomplcache#close_popup() . "\<Up>"
"inoemap <expr><Down>  neocomplcache#close_popup() . "\<Down>"
" O set this.
"let g:neocomplcache_enable_cusor_hold_i = 1
" O set this.
"let g:neocomplcache_enable_inset_char_pre = 1
...
" Enable heavy omni completion.
if !exists('g:neocomplcache_omni_pattens')
  let g:neocomplcache_omni_pattens = {}
endif
let g:neocomplcache_omni_pattens.php = '[^. \t]->\h\w*\|\h\w*::'
let g:neocomplcache_omni_pattens.c = '[^.[:digit:] *\t]\%(\.\|->\)'
let g:neocomplcache_omni_pattens.cpp = '[^.[:digit:] *\t]\%(\.\|->\)\|\h\w*::'

" Fo perlomni.vim setting.
" https://github.com/c9s/pelomni.vim
let g:neocomplcache_omni_pattens.perl = '\h\w*->\h\w*\|\h\w*::'
